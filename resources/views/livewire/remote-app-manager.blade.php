<div>
    ...
    <div class="mb-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <div>
                    ...
                    <div class="flex items-center gap-2 mt-0.5">
                        ...
                        @if($app->sync_method === 'database')
                            <span class="inline-flex items-center gap-1 px-1.5 py-0.5 rounded-full text-[10px] font-semibold bg-violet-50 dark:bg-violet-900/30 text-violet-600 dark:text-violet-400 ring-1 ring-violet-500/10">
                        ...
                        @elseif($app->sync_method === 'api')
                            <span class="inline-flex items-center gap-1 px-1.5 py-0.5 rounded-full text-[10px] font-semibold bg-cyan-50 dark:bg-cyan-900/30 text-cyan-600 dark:text-cyan-400 ring-1 ring-cyan-500/10">
            ...
            <button wire:click="loadRemoteData" class="inline-flex items-center gap-2 px-4 py-2.5 text-sm font-medium text-gray-600 dark:text-gray-300 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-700 transition shadow-sm" wire:loading.attr="disabled" wire:target="loadRemoteData">
