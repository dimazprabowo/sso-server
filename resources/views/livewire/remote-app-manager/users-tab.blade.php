<div>
    ...
    <div class="mb-4 flex flex-col sm:flex-row sm:items-center gap-3">
        <div class="relative w-full sm:w-80">
            ...
            <input wire:model.live.debounce.300ms="userSearch" type="text" placeholder="Cari user..." class="w-full pl-10 pr-4 py-2.5 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl text-sm text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/40 focus:border-emerald-500 transition">
        </div>
        <div class="sm:w-44">
            <x-searchable-select
